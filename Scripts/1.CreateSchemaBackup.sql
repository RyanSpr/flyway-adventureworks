...
DECLARE @BackupPath NVARCHAR(256) = N'C:\WorkingFolders\FWD\flyway-adventureworks\backups\AutoBackup.bak';  -- Step 2. Change me to match the location of Flyway Project
